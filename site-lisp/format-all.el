;;; ~/.doom.d/site-lisp/format-all.el -*- lexical-binding: t; -*-
...
;; Version: 0.3.0
;; Package-Requires: ((emacs "24") (cl-lib "0.5") (language-id "0.7"))
...
(define-format-all-formatter lua-format
  ...
  (:install "luarocks install --local --server=https://luarocks.org/dev luaformatter")
  (:languages "Lua")
  (:format (format-all--buffer-easy executable)))
